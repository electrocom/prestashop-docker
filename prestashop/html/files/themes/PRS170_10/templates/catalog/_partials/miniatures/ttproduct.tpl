		...
		<div class="ttproduct-desc col-sm-7">
			<div class="product-description">
				...
				{block name='product_description_short'}
					<div class="product-desc-short" itemprop="description">{$product.description_short|strip_tags:'UTF-8'|truncate:70:'...' nofilter}</div>
				{/block}
			...
			{block name='product_price_and_shipping'}
					{if $product.show_price}
						<div  itemprop="offers"
							  itemscope
							  itemtype="https://schema.org/Offer" class="product-price-and-shipping">
			...
			<div class="ttqtyprogress">
									<span class="BestQuantityAvailable">{if $product.quantity <= 0}{l s='Unavilable:' d='Shop.Theme.Actions'}{else}{l s='Available:' d='Shop.Theme.Actions'}{/if}</span>
