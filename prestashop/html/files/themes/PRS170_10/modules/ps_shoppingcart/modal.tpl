        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="cart-content">
              ...
              <p><span class="label">{l s='Wartość wszystkich produktów w koszyku:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="value">{$cart.subtotals.products.value}</span></p>
              <p><span>{l s='Dostawa już od:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="value">{$cart.subtotals.shipping.value} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</span></p>



              {if $cart.subtotals.tax}
                <p class="product-tax">{$cart.subtotals.tax.label} {l s='%label%:' sprintf=['%label%' => $cart.subtotals.tax.label] d='Shop.Theme.Global'}&nbsp;<span class="value">{$cart.subtotals.tax.value}</span></p>
              {/if}
